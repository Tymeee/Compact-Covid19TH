...
struct Covid19_Widget3_Previews: PreviewProvider {
    static var previews: some View {
        ...
        Group{
            Covid19_Widget3EntryView(data: Model(date: Date(),covidData: CovidData(Confirmed: 0, Recovered: 0, Hospitalized: 0, Deaths: 0, NewConfirmed: 0, NewRecovered: 0, active: 0, NewDeaths: 0, NewHospitalized: 0, UpdateDate: "")))
